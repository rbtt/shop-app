...
import { Platform, View, Text, TextInput, StyleSheet, TextInputComponent, TextInputProps } from 'react-native'
...
interface Props extends TextInputProps {
    ...
    onInputChange: (inputIdentifier: keyof StateKeys, value: string, isValid: boolean) => void,
    id: keyof StateKeys
}
...
const Input = (props: Props) => {
    ...
    const lostFocusHandler = () => {
        dispatch({ type: 'INPUT_BLUR', value: inputState.value, isValid: inputState.isValid })
    }
